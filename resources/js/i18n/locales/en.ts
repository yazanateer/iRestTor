export default {
    ...
    availability: {
        ...
        halfDayAM: 'Half Day',
        weeklyScheduleDescription: 'Set your default weekly working hours.',
        selectedWeeklyDayHint: 'Editing {day}. Changes here apply to every {day} unless overridden by a special date.',
        weeklyEditorDescription: 'These hours repeat every week for this day.',
        selectDayToEdit: 'Select a day to edit',
        calendarExceptions: 'Calendar Exceptions',
        calendarExceptionsDescription: 'Override the weekly schedule for specific dates.',
        previousMonth: 'Previous month',
        nextMonth: 'Next month',
        override: 'Override',
        selectedDate: 'Selected date',
        usesWeeklySchedule: 'Uses weekly schedule',
        addOverrideDescription: 'This date currently follows the default weekly schedule.',
        overrideThisDate: 'Override this date',
        removeOverride: 'Remove override',
        selectDate: 'Select a date',
        selectDateDescription: 'Choose a date from the calendar to manage its availability.',
        bookingWindow: 'Booking Window',
        bookingWindowDescription: 'Choose how far ahead customers can book appointments.',
        daysAhead: 'days ahead',
        bookingWindowNote: 'Customers will only see available dates within the next {days} days.',
    },
