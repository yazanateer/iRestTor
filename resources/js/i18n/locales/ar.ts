...
features: {
  ...
  business: {
    ...
    register: {
        title: 'أنشئ حسابك',
        subtitle: 'ابدأ فترتك التجريبية المجانية لمدة 7 أيام. لا حاجة لبطاقة ائتمان.',
        nameLabel: 'اسمك',
    ...
    trial: {
        bannerTitle: 'الفترة التجريبية المجانية',
        daysRemaining: 'لا توجد أيام متبقية | تبقّى يوم واحد | تبقّى {count} أيام',
        expiringSoon: 'فترتك التجريبية على وشك الانتهاء.',
        expiredMessage: 'انتهت فترتك التجريبية المجانية. اختر خطة لمتابعة استخدام لوحة التحكم.',
        choosePlan: 'اختر خطة',
    },

    plans: {
        title: 'اختر خطة',
        subtitle: 'انتهت فترتك التجريبية المجانية. اختر خطة لمتابعة استخدام لوحة التحكم.',
        monthly: '/ شهريًا',
        free: 'مجاني',
        choose: 'اختيار الخطة',
        comingSoon: 'الفوترة قريبًا',
        empty: 'لا توجد خطط متاحة حاليًا. يرجى التواصل مع الدعم.',
    },

    verifyEmail: {
        title: 'تحقق من بريدك الإلكتروني',
        message: 'شكرًا لتسجيلك! قبل البدء، هل يمكنك تأكيد بريدك الإلكتروني بالنقر على الرابط الذي أرسلناه إليك للتو؟ إذا لم تستلم البريد الإلكتروني، يسعدنا إرسال رابط آخر.',
