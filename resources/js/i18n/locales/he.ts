...
pagination: {
  ...
  business: {
    ...
    register: {
        ...
        subtitle: 'התחל תקופת ניסיון חינם של 7 ימים. לא נדרש כרטיס אשראי.',
        nameLabel: 'השם שלך',
    ...
    trial: {
        bannerTitle: 'תקופת ניסיון חינם',
        daysRemaining: 'לא נותרו ימים | נותר יום אחד | נותרו {count} ימים',
        expiringSoon: 'תקופת הניסיון שלך עומדת להסתיים.',
        expiredMessage: 'תקופת הניסיון החינמית שלך הסתיימה. בחר/י תוכנית כדי להמשיך להשתמש בלוח הבקרה.',
        choosePlan: 'בחר תוכנית',
    },

    plans: {
        title: 'בחר תוכנית',
        subtitle: 'תקופת הניסיון החינמית שלך הסתיימה. בחר/י תוכנית כדי להמשיך להשתמש בלוח הבקרה.',
        monthly: '/ לחודש',
        free: 'חינם',
        choose: 'בחר תוכנית',
        comingSoon: 'חיוב בקרוב',
        empty: 'אין תוכניות זמינות כרגע. אנא צור/י קשר עם התמיכה.',
    },

    verifyEmail: {
        title: 'אמת את כתובת האימייל שלך',
        message: 'תודה שנרשמת! לפני שנתחיל, נוכל לאמת את כתובת האימייל שלך? לחץ/י על הקישור שזה עתה שלחנו אליך. אם לא קיבלת את האימייל, נשמח לשלוח לך קישור נוסף.',
